@section('title', ' Créer Nouvelle imobilisable')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Ajouter une nouvelle imobilisable</h4>
                        </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('imobilisables.store') }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="code_matricule"
                                            name="code_matricule" placeholder="Entrer le code matricule">
                                    </div>
                                    <div class="form-group col-md-6">
