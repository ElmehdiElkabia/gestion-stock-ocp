@section('title', ' Tableau tout Securite Consomable')
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center list-user-action">
                                                        <button class="btn btn-sm btn-icon btn-info commande-button"
                                                            onclick="handleCommandeButtonClick('{{ route('consomables.commande.export', $consomable->id) }}')"
                                                            data-toggle="tooltip" data-placement="top" title="View">commande</button>
                                                        <button class="btn btn-sm btn-icon btn-warning"
                                                            onclick="handleResptionButtonClick('{{ route('consomables.commande', $consomable->id) }}')"
