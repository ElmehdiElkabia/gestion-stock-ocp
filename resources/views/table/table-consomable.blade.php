               ...
               <div class="card">
                   <div class="card-header d-flex justify-content-between">
                       ...
                       <div class="card-action">
                        <form action="{{ route('consomables.import') }}" method="POST" enctype="multipart/form-data" class="d-inline">
                            @csrf
                        ...
                        <a href="{{ route('consomables.export') }}" class="btn btn-sm btn-primary" role="button">Exporter</a>
                        <a href="{{ route('consomables.create') }}" class="btn btn-sm btn-primary" role="button">Créer nouvelle</a>
                    </div>
                                   ...
                                   <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center list-user-action">
                                            <a class="btn btn-sm btn-icon btn-info" href="{{ route('consomables.show', $consomable->id) }}" data-toggle="tooltip" data-placement="top" title="View">
